function Player(options){
	...
	player.animate = function(){
		...
		// if(player.glide){
			// var key = 19;
			// if(player.animation.morphTargetInfluences[key] >= 0.7){
			// 	player.animation.morphTargetInfluences[key] = 0;
			// 	player.animation.playAnimation("glide", 10);
			// }
		// }
		// else{
		// 	player.animation.setFramerange("eagle_fly", 1);
		// }
