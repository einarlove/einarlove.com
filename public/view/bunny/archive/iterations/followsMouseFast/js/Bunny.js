var Bunny = function( x, y, width, height, color){
	...
	this.moveTowardsMousePos = function(){
		this.destination.x = game.mousePos.x;
	// 	// If mouse is near, don't move
	// 	var distanceFromBunny = Math.abs(game.mousePos.x - this.x)
	// 	if(distanceFromBunny < 40) return;

	// 	if(game.mousePos.x > this.x) this.direction = "right";
	// 	if(game.mousePos.x < this.x) this.direction = "left";
	}
